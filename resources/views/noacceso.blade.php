...
<html lang="es">
    ...
    <body class="authentication-bg">
                    ...
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <svg id="Layer_1" class="svg-computer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 424.2 424.2">
                                <style>
                                    .st0{fill:none;stroke:#ee324d;stroke-width:5;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
                                </style>
                                <g id="Layer_2">
                            ...
                            <h3 class="mt-4">Acceso Restingido</h3>
                            <p class="text-muted">No tiene permiso para acceso a esta Hora</p>

                            <div class="row mt-5 ">
                                <div class="col-md-4 text-center ">
                                    <div class="text-center mt-3 pl-1 pr-1">
                                        <div class="avatar-md rounded-circle bg-soft-primary mx-auto">
                                            <i class="dripicons-clock font-22 avatar-title text-primary"></i>
                                        </div>
        ...
        <footer class="footer footer-alt">
            2019 &copy; Inversiones D&amp;M <a href="" class="text-body">farbesoft</a> 
        </footer>
